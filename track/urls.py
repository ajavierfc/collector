...
urlpatterns = [
    ...
    url(r'^title-delete/(?P<title_id>[0-9]+)(?P<confirmed>[a-z]+)$', views.title_delete, name='title-delete'),
    ...
    url(r'^title/(?P<title_id>[0-9]+)/release-delete/(?P<release_id>[0-9]+)(?P<confirmed>[a-z]+)$', views.release_delete, name='release-delete'),
